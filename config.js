...
const CONFIG = {
  ...
  viewingDistanceCm: 40.0, // Viewing distance in cm (20 to 80)
  ...
  deltaSpatialFreqCpd: 12.94,  // Max - Min range in cpd (default 2.0 cpd). 0 = uniform
  spatialFreqScale: 'logarithmic', // 'linear' or 'logarithmic'
